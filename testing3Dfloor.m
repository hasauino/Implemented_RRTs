...
%% Floor
% [Yfloor,Zfloor] = meshgrid(0:xdim/2:xdim,0:ydim/2:ydim);    Xfloor=100*ones(size(Yfloor,1),size(Yfloor,2));
% groundSurf=surface(Xfloor,Yfloor,Zfloor,'LineStyle','none');
% texture = imread('wall.jpg'); %import the image.
...
ob3=[30 50  30  40];plotObstacleExtrude(ob3);
ob4=[20 30  0  40];plotObstacleExtrude(ob4);
